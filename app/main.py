...
async def main():
    async with async_playwright() as p:
        ...
        await page.set_viewport_size({"width": 1200, "height": 1000}) # Increase viewport height so that more stocks are visible
        ...
        if x_button is not None:
            ...
            await page.wait_for_timeout(100) # Wait for the banner to disappear
